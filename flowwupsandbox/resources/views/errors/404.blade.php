        ...
        <div class="navbar navbar-expand-md navbar-light">
            <div class="navbar-brand">
                <a href="{{url('/')}}" class="d-inline-block">
                    <h4 class="text-default p-0 mt-0 mb-0">Flowwup</h4>
                </a>
            </div>
                ...
                <div class="content d-flex justify-content-center align-items-center">
                    ...
                    <div class="flex-fill">
                        ...
                        <div class="text-center mb-3">
                            ...
                            <h5>Oops, There is no such page, have you typed correct url</h5>
                        </div>
                        <!-- /error title -->
                        ...
                        <div class="row">
                            <div class="col-xl-4 offset-xl-4 col-md-8 offset-md-2">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="#" class="btn btn-primary btn-block"><i class="icon-home4 mr-2"></i> Create New Company</a>
                                    </div>

                                    <div class="col-sm-6">
                                        <a href="#" class="btn btn-light btn-block mt-3 mt-sm-0"><i class="icon-menu7 mr-2"></i> See our plans</a>
                                    </div>
                                </div>
                                <!-- /buttons -->
                ...
                <div class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="navbar-footer">
                        <span class="navbar-text">
                            &copy; 2021. <a href="#">Flowwup</a> by <a href="#" target="_blank">Flowwup</a>
                        </span>
