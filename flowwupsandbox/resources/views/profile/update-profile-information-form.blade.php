                        ...
                        <!-- <div class="row"> -->
                            <!-- <div class="col-md-6"> -->
                                <div class="form-group">
                                    <x-jet-label for="name" class="control-label" value="{{ __('Name') }}" />
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            " />
                                ...
                                <div class="mt-0" x-show="! photoPreview">
                                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}" class="rounded mr-2 border-1 p-2 border-slate-300 shadow" height="128">
                                </div>
